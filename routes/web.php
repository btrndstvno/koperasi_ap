...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::get('/loans/print-form', [LoanController::class, 'printForm'])->name('loans.print-form'); 
    ...
    Route::get('/withdrawals/print-form', [WithdrawalController::class, 'printForm'])->name('withdrawals.print-form');
